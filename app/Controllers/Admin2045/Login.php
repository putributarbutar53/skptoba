...
class Login extends BaseController
{
    ...
    public function login()
    {
        if (get_cookie('admin_cookie_username') && get_cookie('admin_cookie_password') && (get_cookie('admin_cookie_password') != '1')) {
            ...
            session()->set($akun);
            return redirect()->to('admin2045/dashboard');
        }
        $data = [];
        if ($this->request->getMethod() == 'post') {
            ...
            session()->set($akun);
            return redirect()->to("admin2045/dashboard")->withCookies();
        }
    ...
    function lupapassword()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            return redirect()->to("admin2045/lupapassword");
        }
    ...
    function resetpassword()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (!$this->validate($aturan)) {
                ...
                return redirect()->to('admin2045/login')->withCookies();
            }
        }
