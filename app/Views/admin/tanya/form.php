 ...
 <div class="modal-body text-left">
     <form id="add_submit">
         ...
         Pertanyaan:<br />
         <input type="text" name="question" value="<?php if (isset($detail['question'])) echo $detail['question']; ?>" class="form form-control form-50" size="40" /> <br>
         Option 1:<br />
         <input type="text" name="option1" value="<?php if (isset($detail['option1'])) echo $detail['option1']; ?>" class="form form-control form-50" size="40" /> <br>
         Option 2:<br />
         <input type="text" name="option2" value="<?php if (isset($detail['option2'])) echo $detail['option2']; ?>" class="form form-control form-50" size="40" /> <br>
         Option 3:<br />
         <input type="text" name="option3" value="<?php if (isset($detail['option3'])) echo $detail['option3']; ?>" class="form form-control form-50" size="40" /> <br>
         Option 4:<br />
         <input type="text" name="option4" value="<?php if (isset($detail['option4'])) echo $detail['option4']; ?>" class="form form-control form-50" size="40" /> <br>
 ...
 <script>
     ...
     $(document).ready(function() {
         $('#add_submit').submit(function(e) {
             ...
             $.ajax({
                 type: 'POST',
                 url: "<?= site_url('admin2045/question/submitdata') ?>",
                 headers: {
