<nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand">
  ...
  <a class="navbar-brand mr-1 mr-sm-3" href="<?php echo site_url("admin2045/dashboard") ?>">
    ...
    <li class="nav-item dropdown dropdown-on-hover"><a class="nav-link pr-0" id="navbarDropdownUser" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="dropdown-menu dropdown-menu-right py-0" aria-labelledby="navbarDropdownUser">
        <div class="bg-white rounded-soft py-2">
          <a class="dropdown-item font-weight-bold text-warning" href="<?php echo site_url("admin2045/dashboard") ?>"><span class="fas fa-user mr-1"></span><span><?php echo session()->get('admin_name') ?></span></a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?php echo site_url("admin2045/profile") ?>">Setting Profile</a>
          <a class="dropdown-item" href="<?php echo site_url("admin2045/logout") ?>">Logout</a>
        </div>
      </div>
    </li>
  </ul>
