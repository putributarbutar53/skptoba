 ...
 <div class="modal-body text-left">
     <form id="add_submit">
         ...
         SKPD:
         <select type="text" name="id_skpd" value="<?php if (isset($detail['id_skpd'])) echo $detail['id_skpd']; ?>" class="form-control form-50">
         ...
         <br />
         Nomor Handphone Kepala SKPD: <br />
         <input type="text" name="no_handphone" value="<?php if (isset($detail['no_handphone'])) echo $detail['no_handphone'] ?>" class="form form-control form-50" size="40" />
         <br />
         Role: <br>
 ...
 <script>
     ...
     $(document).ready(function() {
         $('#add_submit').submit(function(e) {
             ...
             $.ajax({
                 type: 'POST',
                 url: "<?= site_url('admin2045/admin/submitdata') ?>",
                 headers: {
