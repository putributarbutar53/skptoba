            ...
            <section class="form-page js-mouse-move-container">
                <div class="form-page__img bg-dark-1">
                    <div class="form-page-composition" style="margin-top: 320px;">
                        ...
                        <div class="-el-2"><img data-move="40" class="js-mouse-move" src="<?= base_url() ?>/lapor/img/home-9/hero/5.png" alt="icon"></div>
                    </div>
                </div>
                        ...
                        <div class="row justify-center items-center">
                            <div class="col-xl-8 col-lg-9">
                                <div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
                                    <h3 class="text-30 lh-13"><?= lang('Auth.register') ?></h3>
                                    <p><?= lang('Auth.alreadyRegistered') ?> <a href="<?= url_to('login') ?>"><?= lang('Auth.signIn') ?></a></p>
                                    <?= view('Myth\Auth\Views\_message_block') ?>
                                    <form class="contact-form respondForm__form row y-gap-20 pt-30" action="<?= url_to('register') ?>" method="post">
                                        <?= csrf_field() ?>
                                        <div class="col-lg-6">
                                            <label for="fullname" class="text-16 lh-1 fw-500 text-dark-1 mb-10">Nama</label>
                                            <input type="text" id="fullname" class="form-control" name="fullname" placeholder="Nama">
                                        </div>

                                        <div class="col-lg-6">
                                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10"><?= lang('Auth.email') ?> *</label>
